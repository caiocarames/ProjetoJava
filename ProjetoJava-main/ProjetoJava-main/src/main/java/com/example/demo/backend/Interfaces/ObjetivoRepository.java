...
/**
 * Interface que serve como um repositório da classe {@link Objetivo}, ele é responsável por armazenar os métodos que serão usados na execução do CRUD no banco de dados.
